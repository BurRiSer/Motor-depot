...
<u:html title="${title}">
    ...
    <form action="${urlUserSave}" method="post">
        ...
        <c:if test="${not empty user.id}">
            ...
            <button class="delete" formaction="${urlUserDelete}" formmethod="post" ${disabled}><fmt:message
                    key="user.edit.button.delete"/></button>
        </c:if>
        <c:if test="${not empty user.id}">
            <button class="password-reset" formaction="${urlPasswordReset}" formmethod="post"><fmt:message
                    key="user.edit.button.password.reset"/></button>
        </c:if>
